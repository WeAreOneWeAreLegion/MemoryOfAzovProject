...
public class SoundManager : MonoSingleton<SoundManager> {
    ...
    [FMODUnity.EventRef]
    public string scenarioMemoryOfAzovSound;
    FMOD.Studio.EventInstance soundEventScenarioMemoryOfAzovSound;
    ...
    void Start()
    {
        ...
        soundEventScenarioMemoryOfAzovSound = FMODUnity.RuntimeManager.CreateInstance(scenarioMemoryOfAzovSound);
    ...
    public void ScenarioSoundEnum(SoundRequestScenario srs, Transform target)
    {
        switch (srs)
        {
            ...
            case SoundRequestScenario.S_LockedDoor:
                ...
                break;
            case SoundRequestScenario.S_MemoryOfAzov:
                PlayScenarioMemoryOfAzovSound();
                break;
    ...
    public void PlayScenarioMemoryOfAzovSound()
    {
        soundEventScenarioMemoryOfAzovSound.start();
    }
