...
public class InputsManager : MonoSingleton<InputsManager> {
    ...
    public bool GetBackButtonInputDown()
    {
        return isControllerPlaying ? Input.GetButtonDown(xboxInputs.backButton.ToString()) : Input.GetKeyDown(pcInputs.backButton);
    }
